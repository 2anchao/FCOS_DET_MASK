...
if __name__=="__main__":
    ...
    eval_dataset=VOCDataset(cfg.dataset_dir,resize_size=cfg.image_scale,split='val')
    ...
    model.load_state_dict(torch.load("voc2012_512x800_epoch61_loss0.7096.pth",map_location=torch.device('cpu')))
